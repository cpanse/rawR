...
\vspace{12pt}
1 [Functional Genomics Center Zurich](https://fgcz.ch), [ETH Zurich](https://ethz.ch) / [University of Zurich](https://www.uzh.ch),
Winterthurerstrasse 190, 8057 Zurich, Switzerland

2 [Swiss Institute of Bioinformatics](https://www.sib.swiss/), Quartier Sorge - Batiment Amphipole,
1015 Lausanne, Switzerland

\* Correspondence: <Tobias.Kockmann@fgcz.ethz.ch>

‡ This vignette is based on the unedited work of the manuscript published as [@Kockmann2021] [doi:10.1021/acs.jproteome.0c00866](https://doi.org/10.1021/acs.jproteome.0c00866).
...
```{r readFileHeader, echo=TRUE, message=FALSE, eval=TRUE}
# Download via FTP
...
```{r tartareEH4547, warning=FALSE, message=FALSE, eval=FALSE}
# code snippet for using ExperimentHub
